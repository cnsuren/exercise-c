...
float year_rain(int year,int month,const float arr[year][month]);
void month_rain(int year,int month,const float arr[year][month]);
...
int main(void)
{
	...
	printf("\nThe yearly average is %.1f inches.\n\n", year_rain(YEARS,MONTHS,rain));
	month_rain(YEARS,MONTHS,rain);
return 0;
}
